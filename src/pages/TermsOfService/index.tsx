...
export default function TermsOfService() {
  return (
    <Box w="970px" margin="30px auto 40px">
      <Box w="760px">
        ...
        >
          ...
          <Text fontSize="3xl">第2条（利用登録）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第3条（ユーザーIDおよびパスワードの管理）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第4条（利用料金および支払方法）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第5条（禁止事項）</Text>
          <List as="ol" styleType="decimal">
          ...
          <Text fontSize="3xl">第6条（本サービスの提供の停止等）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第7条（著作権）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第8条（利用制限および登録抹消）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第11条（サービス内容の変更等）</Text>
          <Text fontSize="md">
            当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
          </Text>
          <Text fontSize="3xl">第12条（利用規約の変更）</Text>
          <Text fontSize="md">
            当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
          </Text>
          <Text fontSize="3xl">第13条（個人情報の取扱い）</Text>
          <Text fontSize="md">
            当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
          </Text>
          <Text fontSize="3xl">第14条（通知または連絡）</Text>
          <Text fontSize="md">
            ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
          </Text>
          <Text fontSize="3xl">第15条（権利義務の譲渡の禁止）</Text>
          <Text fontSize="md">
