  ...
  return (
    <div>
      ...
      <ContentPaper>
        ...
        <Sentence>
          <Typography>
            この利用規約（以下、「本規約」といいます。）は、hamchance（以下、「当社」といいます。）がこのウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。
        ...
        <List>
          <ListItem>
            <Typography>1. 法令または公序良俗に違反する行為</Typography>
          </ListItem>
          <ListItem>
            <Typography>2. 犯罪行為に関連する行為</Typography>
          </ListItem>
          <ListItem>
            <Typography>
              3.
          ...
          <NestedList>
            <ListItem>
              <Typography>1. 過度に暴力的な表現</Typography>
            </ListItem>
            <ListItem>
          ...
          <ListItem>
            <Typography>12. 宗教活動または宗教団体への勧誘行為</Typography>
          </ListItem>
          <ListItem>
            <Typography>13. その他、当社が不適切と判断する行為</Typography>
          </ListItem>
        </List>
        ...
        <Typography variant="h5">第7条（著作権）</Typography>
        <List>
          <ListItem>
            <Typography>
              1.
          ...
          <ListItem>
            <Typography>
              ...
              ただし、当社は、本サービスを利用して投稿ないしアップロードされた文章、画像、映像等について、本サービスの改良、品質の向上、または不備の是正等ならびに本サービスの周知宣伝等に必要な範囲で利用できるものとし、
          ...
          <ListItem>
            <Typography>
              3.
              前項本文の定めるものを除き、本サービスおよび本サービスに関連する一切の情報についての著作権およびその他の知的財産権はすべて当社または当社にその利用を許諾した権利者に帰属し、
              ユーザーは無断で複製、譲渡、貸与、翻訳、改変、転載、公衆送信（送信可能化を含みます。）、伝送、配布、出版、営業使用等をしてはならないものとします。
            </Typography>
          </ListItem>
        </List>
        <Typography variant="h5">第8条（利用制限および登録抹消）</Typography>
        <List>
          <ListItem>
            <Typography>
              1.
        ...
        <Typography variant="h5">第11条（サービス内容の変更等）</Typography>
        <Sentence>
          <Typography>
            当社は、ユーザーに通知することなく、本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし、これによってユーザーに生じた損害について一切の責任を負いません。
          </Typography>
        </Sentence>
        <Typography variant="h5">第12条（利用規約の変更）</Typography>
        <Sentence>
          <Typography>
        ...
        <Typography variant="h5">第13条（個人情報の取扱い）</Typography>
        <Sentence>
          <Typography>
            当社は、本サービスの利用によって取得する個人情報については、当社「プライバシーポリシー」に従い適切に取り扱うものとします。
          </Typography>
        </Sentence>
        <Typography variant="h5">第14条（通知または連絡）</Typography>
        <Sentence>
          <Typography>
        ...
        <Typography variant="h5">第15条（権利義務の譲渡の禁止）</Typography>
        <Sentence>
          <Typography>
