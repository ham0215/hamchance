    ...
    <Box w="970px" margin="30px auto 40px">
      <Box w="760px">
        ...
        >
          ...
          <Text fontSize="3xl">第1条（個人情報）</Text>
          <Text fontSize="md">
            「個人情報」とは，個人情報保護法にいう「個人情報」を指すものとし，生存する個人に関する情報であって，当該情報に含まれる氏名，生年月日，住所，電話番号，連絡先その他の記述等により特定の個人を識別できる情報及び容貌，指紋，声紋にかかるデータ，及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。
          </Text>
          <Text fontSize="3xl">第2条（個人情報の収集方法）</Text>
          <Text fontSize="md">
          ...
          <Text fontSize="3xl">第5条（個人情報の第三者提供）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第6条（個人情報の開示）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第7条（個人情報の訂正および削除）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第8条（個人情報の利用停止等）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第9条（プライバシーポリシーの変更）</Text>
          <List as="ol" styleType="decimal">
            <ListItem>
          ...
          <Text fontSize="3xl">第10条（お問い合わせ窓口）</Text>
          <Text fontSize="md">
